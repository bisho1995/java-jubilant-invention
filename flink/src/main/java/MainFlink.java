...
public class MainFlink {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Payload p1 = Payload.builder().id("1").build();
        Payload p2 = Payload.builder().id("2").build();

        environment
                .fromElements(p1,p2)
                .assignTimestampsAndWatermarks(new AssignerWithPeriodicWatermarks<Payload>() {
...
//                            Integer germanyDriverLocationPayload, long l) {
//                        timestamp = System.currentTimeMillis();
//
//                        return timestamp;
//                    }
//                })
                .name(
                        "assigned-timestamps-and-watermarks")
